                                ...
                                <c:forEach items="${listUsers}" var="user">
                                    <tr>
                                        ...
                                        <c:if test="${user.admin}">
                                            <td align="center"><img src="../../resources/admin.png"></td>
                                        </c:if>
                                        <c:if test="${!user.admin}">
                                            <td align="center"></td>
                                        </c:if>
                                        ...
                                        <td align="center"><a href="<c:url value='/edit/${user.id}'/>"><img src="../../resources/edit.png"></a></td>
                                        <td align="center"><a href="<c:url value='/remove/${user.id}'/>"><img src="../../resources/delete.png"></a></td>
                                    </tr>
                                </c:forEach>
                            </table>
                        </c:if>
